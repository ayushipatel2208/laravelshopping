                ...
                <div class="col-12">
                    <div class="card">
                         <div class="card-header">
                            <a href="{{ url('admin/backend/sub_category') }}" class="btn btn-primary btn-sm mb-3 float-end"><i
                                data-feather="plus"></i><strong>Add Sub Category</strong></a>
                            <div class="card-title">SubCategory Table</div>
                           
                         </div>
                            <form action="" method="get">
                                @csrf
                                <div class="card-tools">
                                    <button type="button" onclick="window.location.href='{{ route('sub_table.index') }}'"
                                    class="btn btn-primary btn-sm ms-3 mt-2 mb-15">Reset</button>
                                ...
                                <table id="basic-datatables" class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($subcategories as $subcategory)
                                            <tr>
                                                <td class="text-center">{{ $subcategory->sub_id }}</td>
                                                <td class="text-center">{{ $subcategory->name }}</td>
                                                <td class="text-center">{{ $subcategory->categoryName }}</td>
                                                ...
                                                <a href="#" class="text-danger w-4 h-4 mr-1">
                                                    ...
                                                    <a href="{{ url('admin/backend/editsub_category/' . $subcategory->sub_id) }}"
                                                        class="btn btn-primary btn-sm">Edit</a>
                                                    {{-- <a href="#" onclick="deletesubCategory( {{ $subcategory->sub_id }} )" 
                                                        class="btn btn-danger btn-sm">Delete</a> --}}
                                                        <a href="{{ route('sub_category.delete', $subcategory->sub_id) }}"
