                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{ url('admin/backend/Products/list') }}" class="btn btn-primary btn-sm mb-3 float-end"><i
                                            data-feather="plus"></i><strong>Product Table</strong></a>
...
$("#productForm").submit(function(event) {
    ...
    $.ajax({
        url: '{{ route("product.store") }}', // Ensure this route is correct
    ...
    //     const dropzone = new Dropzone("#pro_img_id", {
    //        url: "{{ route('temp-images.create') }}",
    //        maxFiles: 10,
    //        paramName: "pro_img_id",
    //        addRemoveLinks: true,
    ...
    if (response.status) {
        ...
        $('#product-gallary').append(html); // Append the card to your container
     }//,
