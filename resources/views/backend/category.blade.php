          ...
          <div class="page-inner">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <a href="{{url('admin/backend/list')}}" class="btn btn-primary btn-sm mb-3 float-end"><i data-feather="plus"></i><strong>Back To Category</strong></a>
                  ...
                  <div class="card-action">
                    <button type="submit" href="{{ url('admin/backend/list') }}" class="btn btn-primary">Submit</button>
